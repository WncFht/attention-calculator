...
PARAM_SETS = {
    ...
    "e_q": [Fraction(1, 2), Fraction(3, 2), Fraction(2), Fraction(5, 2),
            Fraction(3), Fraction(1, 3)],
    "ln_q": [Fraction(3, 2), Fraction(4, 3), Fraction(5, 4), Fraction(2), Fraction(3),
             Fraction(4), Fraction(5), Fraction(6), Fraction(7), Fraction(8),
             Fraction(10), Fraction(11), Fraction(16), Fraction(22), Fraction(64),
             Fraction(100), Fraction(257), Fraction(1, 2)],
    "ln_q_square": [Fraction(2), Fraction(3), Fraction(3, 2), Fraction(5)],
    "sin_q": [Fraction(1, 2), Fraction(3, 5), Fraction(1), Fraction(6, 5),
              Fraction(2), Fraction(3)],
    "cos_q": [Fraction(1, 2), Fraction(3, 5), Fraction(1), Fraction(6, 5),
              Fraction(2), Fraction(3)],
    ...
    "sin_pi_q": [Fraction(1, 10), Fraction(1, 8), Fraction(1, 7), Fraction(1, 6),
                 Fraction(1, 5), Fraction(1, 4), Fraction(3, 10), Fraction(1, 3),
                 Fraction(2, 5)],
    "cos_pi_q": [Fraction(1, 10), Fraction(1, 8), Fraction(1, 7), Fraction(1, 6),
                 Fraction(1, 5), Fraction(1, 4), Fraction(3, 10), Fraction(1, 3),
                 Fraction(2, 5)],
    "arctan_q": [Fraction(1, 5), Fraction(1, 3), Fraction(1, 2), Fraction(1),
                 Fraction(2), Fraction(3)],
    "arccot_q": [Fraction(1, 2), Fraction(1), Fraction(2)],
    "sinh_q": [Fraction(1, 2), Fraction(3, 5), Fraction(2, 3), Fraction(1),
               Fraction(2), Fraction(5, 2)],
    "cosh_q": [Fraction(1, 2), Fraction(3, 5), Fraction(2, 3), Fraction(1),
               Fraction(2), Fraction(5, 2)],
    "tanh_q": [Fraction(1, 2), Fraction(3, 5), Fraction(2, 3), Fraction(1),
               Fraction(2), Fraction(5, 2)],
    "coth_q": [Fraction(1, 2), Fraction(3, 5), Fraction(2, 3), Fraction(1),
               Fraction(2), Fraction(5, 2)],
...
def bounds_for(v):
    ...
    if v <= 0:
        ...
        return [Fraction(int(mp.floor(v * 10)), 10), Fraction(0),
        ...
        for q in powers:
            for r in bounds_for(true_value(typ, q)):
                for comp in ("<", ">"):
                    ...
                    if key not in seen:
                        seen.add(key)
                        cases.append({"type": typ, "power": str(q),
                                      "comparison": comp, "rational": str(r)})
...
COMBO_PROBLEMS = [
    # 直接基本型
    "pi<22/7", "pi>3", "e>8/3", "e<3", "pi^2<10", "pi^3>31",
    "ln(2)<7/10", "ln2<7/10", "sin(1)<17/20", "cos(1)>1/2",
    "gamma>1/2", "phi<8/5", "e^pi>23", "phi^2>5/2",
    # 两项加减（含故意方向反）
    "pi+e<6", "pi+e>6", "e-pi>2/5", "pi-e>2/5", "pi-e<1/2",
    "pi+phi<5", "e+gamma<4", "pi+ln(2)<4", "e+sin(1)>7/2",
    "pi+gamma>7/2", "phi+gamma>2", "ln(2)+ln(3)<2", "sin(1)+cos(1)>1",
    "pi^2+pi>13", "2*pi+e<12",
    # 乘除幂
    "pi*e>17/2", "e*pi<9", "pi*e<8", "pi^2+8*pi>35",
    "e*pi+phi+sin(1)<11", "pi*phi>5", "e/pi<1", "pi/e>11/10",
    "ln(2)*e<2", "pi^e>22", "pi^e<23", "e^2+pi>10",
    "2*pi*e>17", "pi^2*e>26", "gamma*pi<2", "sin(1)*pi>5/2",
    "e^2*pi<24", "ln(3)*pi>3",
    # 三项及以上混合
    "pi+e+gamma<7", "pi+e+phi>6", "pi+e+ln(2)+gamma<8",
    "2*pi+3*e+phi>15", "pi+e-gamma<6", "pi+pi+pi>9",
    "sin(1)+cos(1)+tan(1)<3", "ln(2)+ln(3)+ln(5)<4",
    "e*e+pi>10", "pi*e+pi*e<18", "pi-e+phi>2",
    "3*pi+2*e<15", "pi/2+e/3+gamma>3", "e-pi-gamma<0",
    # 除法与括号
    "(pi+e)/2<3", "pi/(e+1)<1", "1/pi+1/e>1/2",
    "(pi+1)/(e+1)>1", "e^2/pi>2", "pi^2/e>3",
    "ln(10)/pi<3/4", "2/(pi+e)>1/3", "2/(pi+e)<7/20",
    # 故意写错 / 格式边界
    "pi<>3", "pi", "pi>3>2", "foo>3", "pi+>3", ">3", "pi>",
    "pi>abc", "pi>3.14", "PI<22/7", "pi < 22/7", "π<22/7",
    "pi^2.5>10", "", "ln(1)>0", "sin(1)", "pi>=3",
]
