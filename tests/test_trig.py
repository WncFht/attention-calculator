...
@pytest.mark.parametrize("kind,power,bound,msg", [
    ...
    ("sin_pi_q", "1/2", "9/10", "请在输入一个在(0,1/2)内的分数，本情况不支持整数"),  # noqa: RUF001
    ("sin_pi_q", "0", "1/2", "请在输入一个在(0,1/2)内的分数，本情况不支持整数"),  # noqa: RUF001
    ("sin_pi_q", "3/6", "1/2", "请在输入一个在(0,1/2)内的分数，本情况不支持整数"),  # noqa: RUF001
    ("cos_pi_q", "1", "1", "请在输入一个在(0,1/2)内的分数，本情况不支持整数"),  # noqa: RUF001
