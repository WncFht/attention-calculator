...
@pytest.mark.parametrize("c,s,k,expected", [
...
@pytest.mark.parametrize("m,n,j,q,square", [
    (0, 0, 0, F(2), False), (2, 3, 1, F(3), False),
    (1, 2, 0, F(3, 2), False), (3, 0, 1, F(5), False),
    (0, 0, 2, F(2), True), (1, 3, 1, F(4), True), (2, 0, 0, F(3, 2), True),
])
def test_basis_moment_numeric(m, n, j, q, square):
    ...
    cq = tomf(c)
    qq = tomf(q)
    val = (tomf(mom.get("ln2", F(0))) * mp.log(qq) ** 2
...
def test_mn_order_log_parity():
    ...
    assert got[:12] == [(0, 0), (0, 1), (1, 0), (1, 1), (2, 0), (0, 2),
                        (1, 2), (2, 1), (0, 3), (3, 0), (2, 2), (3, 1)]
...
@pytest.mark.parametrize("kind,power,comp,bound,expected,solution", [
    ("ln_q", "3", "<", "10/9",
     dict(m=1, n=2, a_val="0", b_val="4/3", c_val="0",
          au_val="0", bu_val="4", cu_val="0", u_val="3"),
     "a = 0, b = 4/3"),
    ("ln_q", "2", ">", "11/16",
     dict(m=0, n=2, a_val="0", b_val="1/8", c_val="0",
          au_val="0", bu_val="1", cu_val="0", u_val="8"),
     "a = 0, b = 1/8"),
    ("ln_q", "2", "<", "347/500",
     dict(m=2, n=2, a_val="31/500", b_val="-2/125", c_val="0",
          au_val="31", bu_val="-8", cu_val="0", u_val="500"),
     "a = 31/500, b = -2/125"),
    # article-famous ln5 bound; s = max(6,7) = 7
    ("ln_q", "5", "<", "375/233",
     dict(m=6, n=7, a_val="3144/1165", b_val="1491584/8155", c_val="0",
          au_val="22008", bu_val="1491584", cu_val="0", u_val="8155"),
     "a = 3144/1165, b = 1491584/8155"),
    ("ln_q", "101/100", "<", "1/50",
     dict(m=0, n=0, a_val="1/100", b_val="1/5000", c_val="0",
          au_val="50", bu_val="1", cu_val="0", u_val="5000"),
     "a = 1/100, b = 1/5000"),
    ("ln_q", "355/113", "<", "23/20",
     dict(m=3, n=1, a_val="1070835569/489142083", b_val="-272755780/163047361",
          c_val="0", au_val="1070835569", bu_val="-818267340", cu_val="0",
          u_val="489142083"),
    ...
    ("ln_q_square", "2", "<", "1/2",
     dict(m=0, n=2, a_val="1/2", b_val="0", c_val="0",
          au_val="1", bu_val="0", cu_val="0", u_val="2"),
     "a = 1/2, b = 0, c= 0"),
    ("ln_q_square", "3/2", "<", "17/100",
     dict(m=2, n=0, a_val="2357/16600", b_val="-313/8300", c_val="-27/1660",
          au_val="2357", bu_val="-626", cu_val="-270", u_val="16600"),
     "a = 2357/16600, b = -313/8300, c= -27/1660"),
    ("ln_q_square", "3", "<", "121/100",
     dict(m=1, n=4, a_val="15343/29700", b_val="5581/1980", c_val="8168/7425",
          au_val="15343", bu_val="83715", cu_val="32672", u_val="29700"),
     "a = 15343/29700, b = 5581/1980, c= 8168/7425"),
    # artanh solves the halved ln system at q~ = (1+q)/(1-q), reported in c_val
    ("artanh_q", "1/2", "<", "11/20",
     dict(m=2, n=3, a_val="1/15", b_val="4/9", c_val="3",
          au_val="3", bu_val="20", cu_val="0", u_val="45"),
     "a = 1/15, b = 4/9"),
    ("artanh_q", "1/10", "<", "11/100",
     dict(m=0, n=1, a_val="89/4950", b_val="7/825", c_val="11/9",
          au_val="89", bu_val="42", cu_val="0", u_val="4950"),
     "a = 89/4950, b = 7/825"),
    ("artanh_q", "9/10", "<", "3/2",
     dict(m=4, n=5, a_val="223830/19", b_val="161409348/95", c_val="19",
          au_val="1119150", bu_val="161409348", cu_val="0", u_val="95"),
    ...
    ("arcoth_q", "2", "<", "11/20",
     ...
     "a = 1/15, b = 4/9"),
    ("arcoth_q", "11/10", "<", "8/5",
     dict(m=4, n=4, a_val="5083468/21", b_val="-679520/7", c_val="21",
          au_val="5083468", bu_val="-2038560", cu_val="0", u_val="21"),
     "a = 5083468/21, b = -679520/7"),
    ("arcoth_q", "3/2", "<", "9/10",
     dict(m=1, n=2, a_val="2", b_val="66/5", c_val="5",
          au_val="10", bu_val="66", cu_val="0", u_val="5"),
     "a = 2, b = 66/5"),
])
...
def test_render_equation_bytes(kind, power, comp, bound, equation):
    res = log_family.prove(kind, F(power), comp, F(bound))
    typed = {k: int(res["parameters"][k])
             for k in ("m", "n", "au_val", "bu_val", "cu_val", "u_val")}
...
CONST_MPF = {
    "ln_q": mp.log, "ln_q_square": lambda q: mp.log(q) ** 2,
    "artanh_q": mp.atanh, "arcoth_q": lambda q: mp.atanh(1 / q),
}


@pytest.mark.parametrize("kind,power,comp,bound", [
    ("ln_q", "3", "<", "10/9"), ("ln_q", "5", "<", "375/233"),
    ("ln_q", "355/113", "<", "23/20"), ("ln_q", "2", ">", "11/16"),
    ("ln_q_square", "2", "<", "1/2"), ("ln_q_square", "3", "<", "121/100"),
    ("ln_q_square", "3/2", "<", "17/100"),
    ("artanh_q", "1/2", "<", "11/20"), ("artanh_q", "9/10", "<", "3/2"),
    ("arcoth_q", "2", "<", "11/20"), ("arcoth_q", "3/2", "<", "9/10"),
])
