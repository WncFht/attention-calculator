...
def params_of(res):
    ...
    return coerce_params(
        {
            k: str(res["parameters"][k])
            for k in ("m", "n", "a_val", "b_val", "c_val", "u_val", "au_val", "bu_val", "cu_val")
        }
    )
...
@pytest.mark.parametrize(
    "kind,power,bound,expected",
    [
        (
            "gauss",
            "1",
            "5/4",
            dict(m=0, n=0, a_val="0", b_val="1/24", au_val="25", bu_val="0", cu_val="2", u_val="4"),
        ),
        (
            "gauss",
            "2",
            "3",
            dict(m=0, n=0, a_val="0", b_val="1/2", au_val="15", bu_val="0", cu_val="2", u_val="1"),
        ),
        (
            "gauss",
            "1/2",
            "1",
            dict(m=0, n=0, a_val="0", b_val="1/3", au_val="5", bu_val="0", cu_val="2", u_val="1"),
        ),
        (
            "gauss",
            "0",
            "1",
            dict(m=0, n=0, a_val="0", b_val="5/6", au_val="5", bu_val="0", cu_val="2", u_val="1"),
        ),
        (
            "varpi",
            "1",
            "15/4",
            dict(m=0, n=0, a_val="0", b_val="1/4", au_val="21", bu_val="0", cu_val="2", u_val="1"),
        ),
        (
            "varpi",
            "1/2",
            "2",
            dict(m=0, n=0, a_val="0", b_val="1/4", au_val="21", bu_val="0", cu_val="2", u_val="2"),
        ),
        ...
        (
            ...
            "0",
            "1/2",
            dict(m=0, n=0, a_val="0", b_val="1/2", au_val="0", bu_val="0", cu_val="2", u_val="1"),
        ),
    ],
)
...
@pytest.mark.parametrize(
    "params,kind,power,comp,bound,equation",
    [
...
@pytest.mark.parametrize(
    "params,power,comp,bound,equation",
    [
...
def test_lnq_wire_pair_denominator(power, equation):
    ...
    assert log_family.render_equation(params, "ln_q", power, "<", "224/125") == equation
...
@pytest.mark.parametrize(
    "kind,comp,power,bound,equation",
    [
...
def test_coef_and_bound_echo(kind, comp, power, bound, equation):
    ...
    module = {"pi": quadlog, "varpi": beta_family, "gauss": beta_family}[kind]
...
def test_trig_pi_cdot_rule():
    ...
    params = coerce_params(
        dict(
            m="1",
            n="3",
            a_val="1905533/18750000",
            b_val="-244321/3125000",
            c_val="3/5",
            u_val="18750000",
    ...
    eq = trig_pi.render_equation(params, "sin_q_degree", "36", ">", "587/1000")
    assert eq == (
