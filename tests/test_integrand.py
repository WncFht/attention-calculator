...
CASES = [
    ...
    ("gauss", ">", "1", "1/4", 0, 0, "0", "1/8", "0", "1", None, "3", "0", "1"),
    ("gauss", ">", "2", "0", 0, 0, "0", "3/4", "0", "1", None, "6", "0", "1"),
    ...
    # varpi '>' 兜底（cu=1）：∫(au/u)x(1-x)√(1-x⁴)/π + b_val
    ("varpi", ">", "1", "0", 0, 0, "0", "1", "0", "1", None, "0", "0", "1"),
    ("varpi", ">", "1", "1/2", 0, 0, "0", "11/16", "0", "2", None, "5", "0", "1"),
