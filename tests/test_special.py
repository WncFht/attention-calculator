...
def test_solved_identity_is_exact():
    ...
    lhs = combine([F(res["parameters"]["a_val"]), F(res["parameters"]["b_val"])],
                  basis)
...
SITE_PARAMS = [
    ("golden", "1", ">", "0",
     dict(m=0, n=0, a_val="89/160", b_val="13/32", au_val="89", bu_val="65",
          u_val="160"), "a = 89/160, b = 13/32"),
    ("golden", "1", "<", "2",
     dict(m=0, n=0, a_val="11/160", b_val="7/32", au_val="11", bu_val="35",
          u_val="160"), "a = 11/160, b = 7/32"),
    ("golden", "1", ">", "8/5",
    ...
    ("varpi", "1", "<", "3",
     dict(m=0, n=1, a_val="6", b_val="0", u_val="1"), "a = 6, b = 0"),
    ("varpi", "1", "<", "14/5",
     dict(m=0, n=1, a_val="0", b_val="42/5", u_val="5"), "a = 0, b = 42/5"),
    ("varpi", "1", "<", "31/10",
     dict(m=0, n=1, a_val="9", b_val="-21/5", u_val="5"), "a = 9, b = -21/5"),
    ("varpi", "1", "<", "11/4",
     dict(m=1, n=1, a_val="33/20", b_val="33/4", au_val="33", bu_val="165",
          u_val="20"), "a = 33/20, b = 33/4"),
    ("varpi", "1", "<", "53/20",
     dict(m=10, n=1, a_val="3113915036463/1960525168640",
          b_val="36939482878011/1960525168640", u_val="1960525168640"),
     "a = 3113915036463/1960525168640, b = 36939482878011/1960525168640"),
    ("varpi", "1", ">", "2",
     dict(m=0, n=0, a_val="4", b_val="0", u_val="1"), "a = 4, b = 0"),
    ("varpi", "1", ">", "5/2",
     dict(m=2, n=0, a_val="53/7", b_val="26/7", u_val="7"),
     "a = 53/7, b = 26/7"),
    # '>' sqrt(1-x^4)-numerator fallback: a_val=0, au/u = t, cu_val=1
    ("varpi", "1", ">", "0",
     dict(m=0, n=0, a_val="0", b_val="1", au_val="0", bu_val="0", cu_val="1",
          u_val="1"), "a = 0, b = 0"),
    ("varpi", "1", ">", "1/2",
     dict(m=0, n=0, a_val="0", b_val="11/16", au_val="5", bu_val="0",
          cu_val="1", u_val="2"), "a = 0, b = 0"),
    ("gauss", "1", "<", "9/10",
     dict(m=0, n=1, a_val="0", b_val="3", u_val="1"), "a = 0, b = 3"),
    ("gauss", "1", "<", "1",
     dict(m=0, n=1, a_val="2", b_val="0", u_val="1"), "a = 2, b = 0"),
    ("gauss", "1", "<", "7/8",
     dict(m=1, n=1, a_val="0", b_val="15/4", u_val="4"), "a = 0, b = 15/4"),
    ("gauss", "1", "<", "171/200",
    ...
    ("gauss", "1", "<", "167/200",
     dict(m=5, n=1, a_val="763113/209", b_val="79648569/25600",
          u_val="5350400"),
     "a = 763113/209, b = 79648569/25600"),
    ("gauss", "1", ">", "4/5",
     dict(m=2, n=0, a_val="6/5", b_val="44/5", u_val="5"), "a = 6/5, b = 44/5"),
    ("gauss", "1", ">", "1/2",
     dict(m=0, n=0, a_val="2", b_val="0", u_val="1"), "a = 2, b = 0"),
    ("gauss", "1", ">", "3/8",
     dict(m=0, n=0, a_val="3", b_val="-3", u_val="1"), "a = 3, b = -3"),
    ("gauss", "1", ">", "3/4",
     dict(m=0, n=0, a_val="0", b_val="6", u_val="1"), "a = 0, b = 6"),
    # '>' sqrt fallback records
    ("gauss", "1", ">", "0",
     dict(m=0, n=0, a_val="0", b_val="3/8", au_val="3", bu_val="0",
          cu_val="1", u_val="1"), "a = 0, b = 0"),
    ("gauss", "1", ">", "1/4",
     dict(m=0, n=0, a_val="0", b_val="1/8", au_val="3", bu_val="0",
          cu_val="1", u_val="1"), "a = 0, b = 0"),
    ("gauss", "2", ">", "0",
     dict(m=0, n=0, a_val="0", b_val="3/4", au_val="6", bu_val="0",
          cu_val="1", u_val="1"), "a = 0, b = 0"),
    # gamma composite kernel; u_val=0 records print a degenerate solution line
    ("gamma", "1", ">", "0",
     dict(m=0, n=0, a_val="1/2", b_val="0", c_val="1", cu_val="0",
          u_val="0"), "a = 0, b = 0"),
    ("gamma", "1", "<", "1",
     dict(m=0, n=0, a_val="1/4", b_val="0", c_val="2", cu_val="0",
          u_val="0"), "a = 0, b = 0"),
    ("gamma", "1", ">", "1/2",
     dict(m=0, n=0, a_val="0", b_val="0", c_val="1", cu_val="0",
          u_val="0"), "a = 0, b = 0"),
    ("gamma", "1", "<", "3/5",
     dict(m=2, n=4, a_val="937/56", b_val="4615/42", c_val="0", cu_val="5",
          au_val="2811", bu_val="18460", u_val="168"),
     "a = 937/56, b = 4615/42"),
    ("gamma", "1", ">", "57/100",
     dict(m=4, n=2, a_val="67", b_val="-304/5", c_val="0", cu_val="4",
          au_val="335", bu_val="-304", u_val="5"),
     "a = 67, b = -304/5"),
    ("gamma", "1", "<", "29/50",
     dict(m=7, n=8, a_val="135299452736339/425425",
          b_val="-122801520422253/425425", c_val="0", cu_val="16",
          u_val="425425"),
     "a = 135299452736339/425425, b = -122801520422253/425425"),
]


@pytest.mark.parametrize("kind,power,comp,bound,expected,solution",
                         SITE_PARAMS)
...
def test_render_equation_bytes(kind, power, comp, bound, equation):
    res = solve.prove(kind, power, comp, bound)
    typed = coerce_params({k_: str(res["parameters"][k_]) for k_ in (
...
def test_gauss_lt_transposed_fallback_is_site_bug():
    ...
    basis = [beta_family.lemniscate_basis("gauss", "<", p["m"], i)
             for i in (0, 1)]
    target = {"gauss_inv": F(21, 25), "1": F(-1)}
    # transposed: basis_i · (a,b) == target_i in [gauss_inv, "1"] order
    for bvec, tval in zip(basis, (target["gauss_inv"], target["1"]),
                        strict=True):
...
@pytest.mark.parametrize("kind,comp,bound,poly", [
    ("gauss", ">", "0", 3 * (1 - x) * sp.sqrt(1 - x**4) / sp.pi),
    ("gauss", ">", "1/4", 3 * (1 - x) * sp.sqrt(1 - x**4) / sp.pi),
    ("varpi", ">", "1/2", sp.Rational(5, 2) * x * (1 - x)
     * sp.sqrt(1 - x**4) / sp.pi),
])
def test_sqrt_fallback_identity(kind, comp, bound, poly):
    ...
    mp.dps = 35
    val = mp.quad(sp.lambdify(x, f, modules="mpmath"),
                  [mp.mpf(str(lo)), mp.mpf(str(hi))])
