...
CATALAN_VECTORS = [
    ...
    (2, 2, {"catalan": F(4), "1": F(-40298, 11025)},
           {"catalan": F(-4), "1": F(363826, 99225)}),
    (3, 3, {"catalan": F(-8), "1": F(12571156, 1715175)},
...
ZETA_VECTORS = [
    ...
    (1, 0, 2, F(3, 4), {"z3": F(-3, 16), "1": F(1, 4)},
                       {"z3": F(3, 16), "1": F(-7, 32)}),
    (0, 1, 2, F(3, 4), {"z3": F(3, 8), "1": F(-1, 4)},
                       {"z3": F(-3, 8), "1": F(15, 32)}),
    (1, 1, 2, F(3, 4), {"z3": F(-3, 8), "1": F(15, 32)},
                       {"z3": F(3, 8), "1": F(-193, 432)}),
    # r=4 -> eta(5) = 15/16 zeta(5); article's zeta(5) table
    (0, 0, 4, F(15, 16), {"z3": F(45, 64)}, {"z3": F(-45, 64), "1": F(3, 4)}),
    (1, 0, 4, F(15, 16), {"z3": F(-45, 64), "1": F(3, 4)},
                         {"z3": F(45, 64), "1": F(-93, 128)}),
    (0, 1, 4, F(15, 16), {"z3": F(45, 32), "1": F(-3, 4)},
                         {"z3": F(-45, 32), "1": F(189, 128)}),
    (1, 1, 4, F(15, 16), {"z3": F(-45, 32), "1": F(189, 128)},
...
def test_ln_moments_vs_mpmath():
    ...
    for odd, r, const in [(False, 1, mp.catalan), (True, 2, eta(3)),
                          (True, 1, eta(2)), (False, 2, mp.pi**3 / 32)]:
        ...
        for c, mom in enumerate([a_mom, b_mom]):
            with mp.workdps(50):
                want = mp.quad(
                    ...
                    x ** (2 * m) * (1 - x**2) ** n * x ** (2 * c)
                    * mp.log(1 / x) / (1 + x**2), [0, 1])
                got = (mp.mpf(str(mom.get("1", 0)))
                       + mp.mpf(str(mom.get("C", 0))) * mp.catalan)
...
SITE_CASES = [
    ("pi", "1", "<", "22/7", dict(m=3, n=3, a_val="47/120", b_val="-13/120",
                                  au_val="47", bu_val="-13", cu_val="0", u_val="120")),
    ("pi", "8", ">", "25", dict(m=2, n=2, a_val="61/8", b_val="-3/8",
                                 au_val="61", bu_val="-3", cu_val="0", u_val="8")),
    ("pi", "1", "<", "355/113", dict(m=5, n=8, a_val="260341/25919488",
                                      b_val="-144651/25919488", au_val="260341",
                                      bu_val="-144651", cu_val="0", u_val="25919488")),
    ("pi", "1", "<", "4", dict(m=0, n=0, a_val="0", b_val="4",
                                 au_val="0", bu_val="4", cu_val="0", u_val="1")),
    ("pi", "1", ">", "3", dict(m=1, n=1, a_val="1/2", b_val="5/2",
                                 au_val="1", bu_val="5", cu_val="0", u_val="2")),
    ("pi", "1", "<", "16/5", dict(m=1, n=1, a_val="1", b_val="-1",
                                   au_val="1", bu_val="-1", cu_val="0", u_val="1")),
    ("pi", "1", ">", "31/10", dict(m=1, n=2, a_val="5/16", b_val="21/16",
                                    au_val="5", bu_val="21", cu_val="0", u_val="16")),
    ("pi", "1", "<", "104348/33215", dict(m=9, n=10, a_val="2501801/1219952640",
                                           b_val="-2263639/1219952640",
                                           au_val="2501801", bu_val="-2263639",
                                           cu_val="0", u_val="1219952640")),
    ("pi", "1", ">", "3141592653589793/1000000000000000", dict(m=14, n=18)),
    ("pi", "3/2", "<", "5", dict(m=0, n=1, a_val="0", b_val="3",
                                   au_val="0", bu_val="3", cu_val="0", u_val="1")),
    ("pi_n", "2", "<", "10", dict(m=1, n=2, a_val="108/13", b_val="-48/13",
                                   au_val="108", bu_val="-48", cu_val="0", u_val="13")),
    ("pi_n", "2", ">", "49/5", dict(m=1, n=2, a_val="36/65", b_val="816/65",
                                     au_val="36", bu_val="816", cu_val="0", u_val="65")),
    ("pi_n", "3", ">", "31", dict(m=2, n=3, a_val="338003449/217788864",
                                   b_val="-97574279/217788864", au_val="338003449",
                                   bu_val="-97574279", cu_val="0", u_val="217788864")),
    ("pi_n", "4", ">", "97", dict(m=1, n=1, a_val="1536/455", b_val="63936/455",
                                   au_val="1536", bu_val="63936", cu_val="0", u_val="455")),
    ("pi_n", "1", "<", "22/7", dict(m=3, n=3, a_val="47/120", b_val="-13/120",
                                     au_val="47", bu_val="-13", cu_val="0", u_val="120")),
    ("pi_n", "5", ">", "306", dict(m=1, n=2, a_val="52763017/902260960",
                                    b_val="2939998089/902260960", au_val="52763017",
                                    bu_val="2939998089", cu_val="0", u_val="902260960")),
    ("pi_n", "6", "<", "962", dict(m=2, n=0, a_val="25308/155", b_val="105948/155",
                                    au_val="25308", bu_val="105948", cu_val="0", u_val="155")),
    ("pi_n", "10", ">", "93648", dict(m=3, n=0, a_val="5827661824/50290065",
                                       b_val="19130220544/50290065", au_val="5827661824",
                                       bu_val="19130220544", cu_val="0", u_val="50290065")),
    ("pi_n", "5/2", ">", "17", dict(m=1, n=0, a_val="6859/40", b_val="7371/40",
                                     au_val="6859", bu_val="7371", cu_val="0", u_val="40")),
    ("pi_n", "5/2", "<", "35/2", dict(m=2, n=0, a_val="1092961/38880",
                                       b_val="318125/7776", au_val="1092961",
                                       bu_val="1590625", cu_val="0", u_val="38880")),
    ("pi_n", "1/3", "<", "3/2", dict(m=0, n=1, a_val="1/16", b_val="33/16",
                                      au_val="1", bu_val="33", cu_val="0", u_val="16")),
    ("arctan_q", "2", "<", "6/5", dict(m=1, n=3, a_val="1871/500", b_val="-177/125",
                                        au_val="1871", bu_val="-708", cu_val="0",
                                        u_val="500")),
    ("arctan_q", "1/2", "<", "1/2", dict(m=0, n=0, a_val="0", b_val="1/8",
                                          au_val="0", bu_val="1", cu_val="0", u_val="8")),
    ("arctan_q", "1/3", "<", "28/87", dict(m=1, n=1, a_val="13/15660",
                                            b_val="-1/3132", au_val="13", bu_val="-5",
                                            cu_val="0", u_val="15660")),
    ("arctan_q", "2/3", "<", "3/5", dict(m=0, n=1, a_val="1/390", b_val="6/65",
                                          au_val="1", bu_val="36", cu_val="0", u_val="390")),
    ("arctan_q", "2/3", "<", "59/100", dict(m=1, n=1, a_val="407/14040",
                                             b_val="-97/3510", au_val="407", bu_val="-388",
                                             cu_val="0", u_val="14040")),
    ("arctan_q", "1/3", ">", "31/97", dict(m=0, n=1, a_val="23/5820",
                                            b_val="-19/5820", au_val="23", bu_val="-19",
                                            cu_val="0", u_val="5820")),
    ("arctan_q", "1", "<", "4/5", dict(m=1, n=1, a_val="1/4", b_val="-1/4",
                                        au_val="1", bu_val="-1", cu_val="0", u_val="4")),
    ("arccot_q", "1/2", "<", "6/5", dict(m=1, n=3, a_val="1871/500",
                                          b_val="-177/125", au_val="1871",
                                          bu_val="-708", cu_val="0", u_val="500")),
    ("arccot_q", "2", ">", "23/50", dict(m=1, n=1, a_val="1/40", b_val="1/80",
                                          au_val="2", bu_val="1", cu_val="0", u_val="80")),
    ("catalan", "1", "<", "109/119", dict(m=5, n=5, a_val="733466923/43978014720",
                                           b_val="-640846037/43978014720",
                                           au_val="733466923", bu_val="-640846037",
                                           cu_val="0", u_val="43978014720")),
    ("catalan", "2", "<", "2", dict(m=0, n=0, a_val="0", b_val="2",
                                     au_val="0", bu_val="2", cu_val="0", u_val="1")),
    ("zeta3", "1", ">", "119/99", dict(m=3, n=4, a_val="35045/3681689",
                                        b_val="3786824/11045067", au_val="105135",
                                        bu_val="3786824", cu_val="0", u_val="11045067")),
    ("zeta3", "1", ">", "1", dict(m=1, n=0, a_val="16/3", b_val="32/3",
                                   au_val="16", bu_val="32", cu_val="0", u_val="3")),
    ("zeta3", "2", ">", "2", dict(m=1, n=0, a_val="32/3", b_val="64/3",
                                   au_val="32", bu_val="64", cu_val="0", u_val="3")),
]


@pytest.mark.parametrize("kind,power,comp,bound,expected", SITE_CASES,
...
def test_identity_holds_numerically(kind, power, comp, bound):
    ...
    q = mp.mpf(str(F(power) if kind == "arctan_q"
                   else (1 / F(power) if kind == "arccot_q" else 1)))
    ...
    def f(x):
        return (x ** (2 * m + odd) * (1 - x**2) ** n * (a + b * x**2)
                * mp.log(1 / x) ** r_ln / (1 + q**2 * x**2))
    ...
    with mp.workdps(50):
        ...
        if kind == "pi_n":
            ...
            target = (mp.mpf(str(F(bound) ** pw.denominator))
                      - mp.pi ** pw.numerator)
        else:
